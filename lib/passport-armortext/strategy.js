...
function Strategy(options, verify) {
  options = options || {}; 
  options.authorizationURL = options.authorizationURL || 'https://demo.armortext.com/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://demo.armortext.com/oauth2/token';
  this.profileUrl = options.profileUrl || "https://demo.armortext.com/api/v1/users/me/profile";
